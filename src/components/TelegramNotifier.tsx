...
const TelegramNotifier: React.FC = () => {
  ...
  useEffect(() => {
    const checkBackendStatus = async () => {
      try {
        const response = await fetch("https://0d8e909a-7fc9-4bf7-b381-5bb3f4b2ff7f.e1-us-east-azure.choreoapps.dev/api/health");
        if (response.ok) {
  ...
  const testBotToken = async (token: string): Promise<boolean> => {
    try {
      const response = await fetch("https://0d8e909a-7fc9-4bf7-b381-5bb3f4b2ff7f.e1-us-east-azure.choreoapps.dev/api/test-notification", {
        method: "POST",
  ...
  const sendNotification = async () => {
    ...
    try {
      ...
      const res = await fetch("https://0d8e909a-7fc9-4bf7-b381-5bb3f4b2ff7f.e1-us-east-azure.choreoapps.dev/api/send-notification", {
        method: "POST",
        headers: { 
